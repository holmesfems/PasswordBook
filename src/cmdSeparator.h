...
namespace CmdSeparator
{
    ...
    class CmdSeparator
    {
      public:
        ...
        CmdSeparator();
        CmdSeparator(const std::string &dbpath);
         ...
         *  ```
         */
        inline void registCmd(std::string cmd, std::function<int(Params &)>,
                              std::string help_string = "");
        inline void registCmd(std::string cmd, int (CmdSeparator::*f)(Params &),
                              std::string help_string = "");
      ...
      private:
        ...
        PasswordManager::PasswordManager *_pwdManager;
    ...
    extern const boost::filesystem::path DBPath;
}
